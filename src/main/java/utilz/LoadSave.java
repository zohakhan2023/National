...
public class LoadSave {
    ...
    public static BufferedImage[] GetAllLevels() {
        ...
        try {
            // Collect filenames
            for (int i = 1; ; i++) {
                String resourceName = "/lvls/" + i + ".png";
                InputStream is = LoadSave.class.getResourceAsStream(resourceName);
                if (is == null) {
        ...
        // Sort images by their numeric filename parts
        Collections.sort(images, Comparator.comparingInt(img -> {
            String filename = filenames.get(images.indexOf(img));
